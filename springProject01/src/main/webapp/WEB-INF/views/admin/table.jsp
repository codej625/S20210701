		...
		<div id="layoutSidenav_content">
			<main>
				...
				<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
					<a
						href="${pageContext.request.contextPath}/admin/table?currentPage=${i}">[${i}]</a>
				</c:forEach>
				<c:if test="${pg.endPage < pg.totalPage }">
					<a
						href="${pageContext.request.contextPath}/admin/table?currentPage=${pg.startPage+pg.pageBlock}">[다음]</a>
				</c:if>
			</main>
